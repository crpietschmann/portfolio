  ...
  tags: ["Silverlight", "C#"]
  alias: ["/post/2010/10/22/Silverlight-Modify-MEF-to-load-plugins-from-DLL-and-XAP-files", "/post/2010/10/22/silverlight-modify-mef-to-load-plugins-from-dll-and-xap-files"]
  ---
<!-- more -->
...
<p><a href="http://pietschsoft.com/file.axd?file=SuperDeploymentCatalog_1.cs">SuperDeploymentCatalog.cs</a></p>
