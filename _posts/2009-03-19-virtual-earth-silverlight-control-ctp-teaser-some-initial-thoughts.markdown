...
<a href="/images/postsVEJS_Teaser_001_PolygonPolylineVideo.png"><img style="border-right-width: 0px; display: inline; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px" title="VEJS_Teaser_001_PolygonPolylineVideo" border="0" alt="VEJS_Teaser_001_PolygonPolylineVideo" src="/images/postsVEJS_Teaser_001_PolygonPolylineVideo_thumb.png" width="244" height="214" /></a>   
The second one shows a Tooltip being displayed from the mouse hovering over a Polygon.  
<a href="/images/postsVEJS_Teaser_002_PolygonWithTooltip.png"><img style="border-right-width: 0px; display: inline; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px" title="VEJS_Teaser_002_PolygonWithTooltip" border="0" alt="VEJS_Teaser_002_PolygonWithTooltip" src="/images/postsVEJS_Teaser_002_PolygonWithTooltip_thumb.png" width="244" height="152" /></a>   
